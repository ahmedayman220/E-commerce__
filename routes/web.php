...
//Route::group(['auth','role:admin'])->group(function() {
...
Route::group(['middleware' => ['auth', 'role:vendor'], 'prefix' => 'vendor'], function () {
    ...
    Route::get('/dashboard', [VendorController::class, 'VendorDashboard'])->name('vendor.dashobard');
    ...
    Route::controller(VendorProductController::class)->group(function () {
        ...
        Route::post('/update/product/thambnail', 'VendorUpdateProductThabnail')->name('vendor.update.product.thambnail');

        Route::post('/update/product/multiimage', 'VendorUpdateProductmultiImage')->name('vendor.update.product.multiimage');

        Route::get('/product/multiimg/delete/{id}', 'VendorMultiimgDelete')->name('vendor.product.multiimg.delete');
    ...
    Route::controller(VendorOrderController::class)->group(function () {
        Route::get('/order', 'VendorOrder')->name('vendor.order');

        Route::get('/return/order', 'VendorReturnOrder')->name('vendor.return.order');

        Route::get('/complete/return/order', 'VendorCompleteReturnOrder')->name('vendor.complete.return.order');
        Route::get('/order/details/{order_id}', 'VendorOrderDetails')->name('vendor.order.details');
    ...
    Route::controller(ReviewController::class)->group(function () {
        ...
        Route::get('/all/review', 'VendorAllReview')->name('vendor.all.review');
